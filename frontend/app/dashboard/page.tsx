...
export default async function DashboardPage() {
    ...
    return (
      <div className="min-h-screen bg-[#0a0f0a] text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mb-4 text-gray-400">Please click the sign-in button in the top right to access the dashboard.</p>
  ...
  return <Dashboard userName={user.name ?? ""} userEmail={user.email ?? ""} />;
}
